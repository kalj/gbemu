...
uint8_t Sound::read_reg(uint8_t regid) const {
    switch (regid) {
        ...
        case REG_NR12:
            return (this->ch1_env_initial_vol & 0xf) << 4 | (static_cast<uint8_t>(this->ch1_env_dir_increase) << 3) |
                   (this->ch1_env_n_steps & 0x7);
        case REG_NR13:
        ...
        case REG_NR22:
            return (this->ch2_env_initial_vol & 0xf) << 4 | (static_cast<uint8_t>(this->ch2_env_dir_increase) << 3) |
                   (this->ch2_env_n_steps & 0x7);
        case REG_NR23:
            return 0xff; // Write Only
        case REG_NR24:
        ...
        case REG_NR41:
            return 0xff; // Write Only
        case REG_NR42:
            return (this->ch4_env_initial_vol & 0xf) << 4 | (static_cast<uint8_t>(this->ch4_env_dir_increase) << 3) |
                   (this->ch4_env_n_steps & 0x7);
        case REG_NR43:
